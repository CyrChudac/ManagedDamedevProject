...
public class CharacterController2D : MonoBehaviour
{
	...
	const float k_CeilingRadius = 0.15f;
	...
	public BoolEvent OnSneakEvent;
	private bool m_wasSneaking = false;
	...
	private void Awake()
	{
		...
		if (OnSneakEvent == null)
			OnSneakEvent = new BoolEvent();
	}
	...
	public void Move(float move, bool sneak, bool jump, bool flipping=true)
	{
		if(!m_Grounded)
