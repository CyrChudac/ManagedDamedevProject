...
public class EnemyVision : MonoBehaviour
{
    ...
    [Header("Events")]
    [SerializeField] private UnityEvent SpottedEvent;
    [SerializeField] private UnityEvent UnseenEvent;
    [SerializeField] private UnityEvent CaughtEvent;
    ...
    private void UpdateMeshes()
    {
        ...
        for (int i = 1; i < RayCount; i++)
        {
            ...
            {
                vertices[i] = Vector2Utils.VectorFromAngle(currAngle) * viewDistance;
            }
    ...
    private void Spotting(bool value) {
        if(isSpotting != value) {
            if(value) {
                SpottedEvent.Invoke();
        ...
        SetInvestigationRate(spottingRatio);
        if(spottingRatio >= 1) {
            CaughtEvent.Invoke();
        }
        isSpotting = value;
