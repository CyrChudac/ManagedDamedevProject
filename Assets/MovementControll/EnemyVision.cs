...
public class EnemyVision : MonoBehaviour
{
    ...
    /// <summary>
    /// how nearby does the player need to be to the viewcone end for him to be seen.
    /// </summary>
    [SerializeField] private float playerMaxSize = 3;
    /// <summary>
    /// Player - when set, improves performence by only calculating vision if near enough.
    /// </summary>
    ...
    protected virtual float GetMaxLength() {
        return viewDistance;
    }
	...
	private void UpdateVision() {
        //if player is too far to be seen
        if(player != null 
            && Vector3.Distance(player.transform.position, transform.position) > playerMaxSize + GetMaxLength()) {
            return;
        }
        Vector3 origin = transform.position;
